...
INSERT INTO `user_group` VALUES (1,'admin'),(2,'user');
/*!40000 ALTER TABLE `user_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_group_right`
--
...
CREATE TABLE `user_group_right` (
  ...
  CONSTRAINT `fk_user_type_rights` FOREIGN KEY (`user_type`) REFERENCES `user_group` (`id_user_types`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_group_right`
--

LOCK TABLES `user_group_right` WRITE;
/*!40000 ALTER TABLE `user_group_right` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_group_right` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_info` (
  `id_userInfo` int unsigned NOT NULL AUTO_INCREMENT,
  `userID` int NOT NULL,
  PRIMARY KEY (`id_userInfo`),
  UNIQUE KEY `id_userInfo_UNIQUE` (`id_userInfo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `fk_user_type_idx` (`user_group`),
  CONSTRAINT `fk_user_type` FOREIGN KEY (`user_group`) REFERENCES `user_group` (`id_user_types`)
...
-- Dump completed on 2025-11-01 21:28:02
